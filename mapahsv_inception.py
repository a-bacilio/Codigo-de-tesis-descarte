...
tronco_dp1=Dropout(0.5)(tronco_pool1)
...
incept_rama4_pool1=MaxPooling2D(pool_size=(2, 2),
                            strides=[1,1],
                            border_mode='same',
                            dim_ordering='default')(tronco_dp1)
...
tronco_dp2=Dropout(0.5)(tronco_pool2)

tronco_flat=Flatten()(tronco_dp2)
