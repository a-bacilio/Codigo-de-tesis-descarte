...
#modelo combinado del bloque Resnet y el módulo Inception
...
codename='mapahsv_combinado'
data_dir='Data/mapahsv/'
...
#datos de los mapas HSV obtenidos de las imagenes de cacao sano y enfermos)
...
incept_rama1_conv1=Convolution2D(32, 1, 1,
                           subsample=(1, 1),
                           border_mode='same')(reconexion_res_tronco)
...
tronco_pool2=AveragePooling2D(pool_size=(2, 2),
                 strides=[2,2],
                 border_mode='valid',
...
tronco_fc1=Dense(nb_classes,activation="sigmoid")(tronco_flat)
